...
const formSchema = z.object({
    ...
    amount: z.string().min(1, "Valor é obrigatório"), // Handling as string for currency input mask eventually
...
export function AccountsPayableForm({ onSuccess, initialData }: AccountsPayableFormProps) {
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            description: "",
            amount: "",
            supplier_id: "none", // workaround for select optional?
            category_id: "none",
    ...
    const onSubmit = async (values: FormValues) => {
        ...
        try {
            const payload = {
                ...
                amount: parseFloat(values.amount.replace(",", ".")), // Basic sanitization
            ...
            toast({
                title: "Erro",
                description: "Falha ao salvar conta a pagar.",
                variant: "destructive",
            });
        }
    };
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="Ex: Aluguel, Compra de Material" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
