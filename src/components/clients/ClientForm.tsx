    ...
    useEffect(() => {
        if (initialData) {
            const maskedData = {
                ...
                dados_bancarios_titular_cpf_cnpj: initialData.dados_bancarios_titular_cpf_cnpj?.length > 11
                    ? maskCNPJ(initialData.dados_bancarios_titular_cpf_cnpj)
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                {/* Cabeçalho do Formulário (Sempre visível) */}
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <TabsContent value="endereco" className="pt-4 space-y-4 animate-in fade-in duration-300">
                        ...
                        <p className="text-[11px] text-green-700 font-semibold cursor-pointer flex items-center gap-1 mt-2">
                            <span className="text-lg">+</span> Clique aqui para adicionar um endereço de entrega diferente deste
                        </p>
                    </TabsContent>
                    ...
                    <TabsContent value="contato" className="pt-4 space-y-4 animate-in fade-in duration-300">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            <Checkbox id="portal_omie" className="border-slate-400" />
                            <label htmlFor="portal_omie" className="text-[11px] text-green-700 font-semibold cursor-pointer">
                                Portal Omie: <span className="font-bold">enviar anexos por e-mail</span> além do link para o Portal Omie para este cliente
                            </label>
                        </div>
                    </TabsContent>

                    <TabsContent value="banco" className="pt-4 space-y-4 animate-in fade-in duration-300">
                        <p className="text-xs font-bold text-slate-700">Preencha aqui os dados bancários <span className="font-normal text-slate-500">deste cliente, fornecedor ou funcionário</span></p>
                        <p className="text-[10px] text-slate-400 -mt-3">Eles poderão ser utilizados para realizar a integração dos pagamentos automaticamente com o seu banco</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="md:col-span-2">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-slate-500 text-[10px] font-bold uppercase">Observações Internas <span className="text-slate-400 font-normal lowercase">(elas serão exibidas apenas aqui)</span></FormLabel>
                                            <FormControl>
