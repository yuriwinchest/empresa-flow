...
export default function Dashboard() {
  ...
  const tabs = [
    ...
    { id: "produtos", label: "Produtos", icon: Package, color: "text-orange-600", bg: "bg-orange-100", route: "/operacional" },
    { id: "contas_pagar", label: "Contas a Pagar", icon: ArrowDownCircle, color: "text-red-600", bg: "bg-red-100", route: "/contas-pagar" },
    { id: "contas_receber", label: "Contas a Receber", icon: ArrowUpCircle, color: "text-green-600", bg: "bg-green-100", route: "/contas-receber" },
    { id: "clientes", label: "Clientes", icon: Users, color: "text-indigo-600", bg: "bg-indigo-100", route: "/clientes" },
    { id: "oportunidades", label: "Oportunidades", icon: Target, color: "text-purple-600", bg: "bg-purple-100", route: "/crm" },
    { id: "departamentos", label: "Departamentos", icon: Layers, color: "text-slate-600", bg: "bg-slate-100", route: "/operacional" },
  ] as const;
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
          {tabs.map((tab) => (
            <button
              ...
              className="flex flex-col items-center justify-center p-4 rounded-xl border transition-all bg-white border-slate-200 hover:border-green-300 hover:bg-slate-50"
            >
